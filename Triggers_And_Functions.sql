...
END;
-- Boolean-like function -- 1 for True, 0 for false
CREATE OR REPLACE FUNCTION Check_If_Patient_Visit_Possible (date_in IN DATE, doctor_id IN CHAR(4)) RETURN NUMBER
IS
...
BEGIN
	...
	appointment_check := Check_If_Patient_Visit_Possible (:new.pv_t,:new.pv_d_id);
