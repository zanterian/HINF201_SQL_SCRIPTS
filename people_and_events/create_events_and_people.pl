...
$AMOUNT_OF_DOCTORS = 25;
$AMOUNT_OF_PATIENTS = 2500;
$AMOUNT_OF_VISITS = 10000;
# File names
...
# encounter string: to_date('','yyyy/mm/dd:hh24:mi')
sub gen_encounter_date{
	...
	my $time = &gen_time;
	return "to_date('$year/$month/$day:$time','yyyy/mm/dd:hh24:mi')";
}
